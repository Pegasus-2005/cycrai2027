...
// import logo from "../assets/image/file_00000000ed848206b903a812b65a1651.png";

// export default function Footer() {
//   return (
//     <footer className="bg-[#020617] text-white border-t border-cyan-400/10">
...
//               <li>
//                 <a href="#home" className="text-gray-300 hover:text-[#FFD700]">
//                   Home
//                 </a>
//               </li>
//               <li>
//                 <a href="#about" className="text-gray-300 hover:text-[#FFD700]">
//                   About
//                 </a>
//               </li>
//               <li>
//                 <a href="#tracks" className="text-gray-300 hover:text-[#FFD700]">
//                   Tracks
//                 </a>
//               </li>
//               <li>
//                 <a href="#venue" className="text-gray-300 hover:text-[#FFD700]">
//                   Venue
//                 </a>
//               </li>
//               <li>
//                 <a href="#contact" className="text-gray-300 hover:text-[#FFD700]">
//                   Contact
//                 </a>
//               </li>
//             </ul>
...
//               {/* Fixed the typo from gamil.com to gmail.com */}
//               <p>
